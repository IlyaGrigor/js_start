...
const currentImage = document.querySelector("#web-tech-image");
let imageIndex = 0;

prevButton.addEventListener("click", function () {
    imageIndex = (imageIndex - 1 + WEB_TECH_IMAGES.length) % WEB_TECH_IMAGES.length;
        currentImage.src = WEB_TECH_IMAGES[imageIndex];
})

nextButton.addEventListener("click", function () {
    imageIndex = (imageIndex + 1) % WEB_TECH_IMAGES.length;
        currentImage.src = WEB_TECH_IMAGES[imageIndex];
})